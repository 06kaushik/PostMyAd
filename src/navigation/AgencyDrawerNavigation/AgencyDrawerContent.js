...
const AgencyDrawerContent = ({ props, navigation }) => {
            ...
            <DrawerContentScrollView {...props} style={{}}>
                ...
                <View style={{ right: 10 }}>
                  ...
                  */}
                    ...
                    <View style={{ left: 20, bottom: 2 }}>
                        <TouchableOpacity onPress={() => navigation.navigate('AgencyWishlist')}>
                    ...
                    <View style={{ left: 20, bottom: 2 }}>
                        <TouchableOpacity onPress={() => navigation.navigate('AgencyTerms')}>
                    ...
                    <View style={{ left: 20, bottom: 2 }}>
                        <TouchableOpacity onPress={() => navigation.navigate('AgencyPrivacy')}>
                    ...
                    <View style={{ left: 20, bottom: 32 }}>
                        <TouchableOpacity onPress={() => navigation.navigate('AgencyContent')}>
                            <Image source={images.privacy} style={{ height: 20, width: 20, }} />
...
export default AgencyDrawerContent

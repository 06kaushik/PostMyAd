...
const GalleryTopNavigator = ({ navigation }) => {
    ...
    return (
        ...
        <>
            ...
            <Tab.Navigator screenOptions={{
                ...
                <Tab.Screen name="Photo" component={PhotoGallery} />
                <Tab.Screen name="Video" component={VideoGallery} />
            </Tab.Navigator>
        </>
...
export default GalleryTopNavigator;

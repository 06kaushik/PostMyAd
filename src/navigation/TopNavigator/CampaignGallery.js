...
import CampaignImageGallery from "../../screens/CampaignScreen/CampaignImages";
import CampaignVideo from "../../screens/CampaignScreen/CampaignVideos";



const Tab = createMaterialTopTabNavigator();

const CampaignGallery = ({ navigation,route }) => {
    ...
    return (
        ...
        <>
            ...
            <Tab.Navigator screenOptions={{
                ...
                <Tab.Screen name="Photo" component={CampaignImageGallery} initialParams={{GalleryData: route?.params}} />
                <Tab.Screen name="Video" component={CampaignVideo} initialParams={{GalleryVideo: route?.params}} />
            </Tab.Navigator>
        </>

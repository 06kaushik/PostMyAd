...
const AgencyOrderTopNavigator = ({ navigation }) => {
    ...
    const GetOrders = async () => {
        if (orderDetail) {
            ...
            try {
                const resp = await axios.post('/api/order/orderListbyuserId', body)
        ...
        return (
            <View style={styles.containerBox}>
                ...
                <View style={{ flexDirection: 'row-reverse', bottom: '8%', right: '5%' }}>
                    <TouchableOpacity onPress={() => navigation.navigate('AgencyOrderDetails', { OrderDetail: item?._id })}>
...
export default AgencyOrderTopNavigator;

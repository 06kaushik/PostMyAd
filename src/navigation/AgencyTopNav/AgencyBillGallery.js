...
import AgencyBillImages from "../../screens/AddAgencyScreens/AgencyGallery/AgencyBillImages";
import AgencyBillVideos from "../../screens/AddAgencyScreens/AgencyGallery/AgencyBillVideo";


const Tab = createMaterialTopTabNavigator();

const AgencyBillGallery = ({navigation,route}) => {
    return(
        <>
        <View style={{backgroundColor:'white',}}>
            ...
            <Tab.Navigator screenOptions={{
                ...
                <Tab.Screen name="Photo" component={AgencyBillImages} initialParams={{ basePrice: route.params,
                ...
                <Tab.Screen name="Video" component={AgencyBillVideos} initialParams={{
...
export default AgencyBillGallery;

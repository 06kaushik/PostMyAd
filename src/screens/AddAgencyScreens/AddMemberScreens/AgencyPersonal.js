...
const AgencyPersonal = ({ navigation }) => {
                        ...
                        <View style={{ marginTop: 10, marginBottom: 20 }}>
                            ...
                            />
                                ...
                                <TouchableOpacity onPress={() => AddMember()}>
                                    <LinearGradient colors={['rgba(225, 65, 195, 1)', 'rgba(185, 55, 250, 1)', 'rgba(105, 6, 195, 1)']} style={{ height: 40, width: 328, alignSelf: 'center', borderRadius: 8 }}>
                                        <View style={{}}>
                                            <Text style={{ color: 'white', alignSelf: 'center', top: 5, fontSize: 16, fontFamily: 'Oswald-Bold' }}>Submit</Text>
                                        </View>

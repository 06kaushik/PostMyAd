...
const AgencyOvervieww = ({ route, navigation }) => {
    ...
    return (
        <View style={styles.mainContainer}>
                    ...
                    <View style={styles.container2}>
                        ...
                        <View style={{ marginTop: 8 }}>
                            <TextInput
                                placeholder=""
                                placeholderTextColor={'grey'}
                                value={String(memberData?.mobileNumber)}
                                style={styles.textInput} />
                        </View>
                    </View>
            ...
            <View style={{ flex: 1 }}>
                <View  style={{ height: 60, width: '100%', bottom: 0, position: 'absolute',backgroundColor:'rgba(183,54,248,255)' }}>
                            ...
                            <RBSheet
                                ...
                                <View style={{ marginLeft: 30, marginTop: 20, }}>
                                    ...
                                    <View style={{ flexDirection: 'row', right: 18 }}>
                                        ...
                                        <Text style={{ fontFamily: 'Oswald-Regular', fontSize: 16, color: 'black', margin: 5 }}>Mobile :    {String(memberData?.mobileNumber)} </Text>
                                    </View>
                                </View>
                            </RBSheet>
                        </TouchableOpacity>
...
export default AgencyOvervieww

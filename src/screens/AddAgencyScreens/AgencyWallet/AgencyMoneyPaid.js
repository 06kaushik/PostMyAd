        ...
        <View style={styles.main}>
            <View style={{ height: 78, backgroundColor: 'rgba(183,54,248,255)' }}>
                <View style={styles.cont}>
                    ...
                    <Text style={styles.txt}>Money Paid</Text>
            ...
            <View style={styles.container}>
                ...
                <View>
                    ...
                    <Text style={styles.added}>Added at 01:25 PM, 31 jul 2022</Text>
                        <Text style={styles.wallet}>Wallet Ref No: 415236547898412</Text>
...
export default AgencyMoneyPaidScreen

...
import { View, Text, ScrollView, Image, TouchableOpacity, StyleSheet, TextInput, ActivityIndicator, Pressable,ToastAndroid } from 'react-native'
...
const AgencyDeposite = ({ navigation, route }) => {
            ...
            <ScrollView>
                <View style={styles.container1}>
                    <View style={styles.containertxt}>
                        ...
                        <Text style={styles.txt}>₹ {walletAmount?.walletBalance}</Text>
                    </View>

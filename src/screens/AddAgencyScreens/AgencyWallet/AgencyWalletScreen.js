...
const AgencyWalletScreen = ({ navigation }) => {
        ...
        return (
            <View>
                <View style={{ marginTop: 12 }}>
                    <TouchableOpacity onPress={() => navigation.navigate('AgencyMoneyAdded', { amount: item.creditedAmount, date: item.transactionDate.slice(0, 10), walletId: item.walletId })}>
            ...
            <ScrollView>
                <View style={styles.cont1}>
                    ...
                    <View style={{ height: 57, width: '90%', backgroundColor: 'rgba(183,54,248,255)', alignSelf: 'center', borderRadius: 15, marginTop: 12 }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate('AgencyWithdraw')}>
                ...
                <View style={{ marginTop: 20, backgroundColor: 'white', elevation: 4, height: 550 }}>
                    ...
                    <View style={{ marginTop: 8 }} >
                        <TouchableOpacity onPress={() => navigation.navigate('AgencyAllTransaction', { walletId: walletAmount?._id })}>

...
const AgencyTermsandCondition = ({navigation}) => {
    return (
        <View>
            <View>
                <View style={{ height: 60,backgroundColor:'rgba(183,54,248,255)' }}>
                    <TouchableOpacity onPress={() => navigation.navigate('Home')}>
                        <View style={{marginTop:'8%'  }}>
                            ...
                            <View>
                            <Text style={{alignSelf:'center',bottom:19,fontFamily:'Oswald-Bold',color:'white'}}>Cancellation Policy</Text>
                            </View>
...
export default AgencyTermsandCondition;

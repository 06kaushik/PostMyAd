...
const AgencyAnalytics = ({ navigation }) => {
    ...
    const pieDataa = [
        ...
        { value: pieData?.approved, color: '#5FCA5D', gradientCenterColor: '#3BE9DE' },
        { value: pieData?.rejected, color: 'red', gradientCenterColor: '#8F80F3' },
        { value: pieData?.pending, color: 'orange', gradientCenterColor: '#FF7F97' },
    ];

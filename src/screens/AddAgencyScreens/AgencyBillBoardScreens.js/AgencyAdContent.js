...
const UserContentScreen = ({ navigation, route }) => {
    ...
    const handleNext = () => {
        ...
        // } else {
        navigation.navigate('AgencyPayment', {
            basePrice: basePrice,
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <View style={{ marginTop: 12 }}>
                            ...
                            <View style={{ marginLeft: 12, marginTop: 8 }}>
                                ...
                                {/* <View>
                                    <TouchableOpacity onPress={() => navigation.navigate('AddBillboards', {
                                        basePrice: basePrice,
                                        selectTime: selectTime,
                                        amount: amount,
                                        duration: duration,
                                        ...
                                        <Text style={{ color: '#B937FA', margin: 5, fontFamily: 'Oswald-Bold' }}> +  Add more Smart BillBoards</Text>
                                    </TouchableOpacity>
                                </View> */}
                            </View>

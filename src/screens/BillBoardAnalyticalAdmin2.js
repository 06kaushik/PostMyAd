...
import SeeMore1 from "../Data/BillBoardData/AnalyticalSeeMore1";
...
const BillBoardAnalyticalSeeMore1 = ({navigation}) => {

    const BillBoardGraph = ({ item }) => {
        return (
            <View>
                <View style={{ top: 30 }} >
                    <Text style={{ textAlign: 'center', color: '#050423', fontWeight: 'bold', fontSize: 20, }}>{item.view}</Text>
        ...
        <View>
           ...
           <View>
            ...
            <View style={{ backgroundColor: 'white', elevation: 4, top: -20,marginBottom:50}}>
                <Text style={{ left: 20, fontFamily: 'Oswald', fontWeight: 'bold', fontSize: 16, color: '#525252',top:20 }}>Views</Text>
                <View style={{left:30}}>
...
export default BillBoardAnalyticalSeeMore1;
...
const RecentBillBoard = ({ navigation, route }) => {

    const [seeAllBillBoard, setSeeAllBillBoard] = useState([])
    console.log('SEE ALL BILLBOARD', seeAllBillBoard);

    const { deviceId } = route.params
    console.log('DEVICE ID IN ORDER', deviceId);
...
export default RecentBillBoard
